...
ActiveRecord::Schema.define(:version => 0) do
  ...
  create_table "entry_answers", :primary_key => "entry_answer_id", :force => true do |t|
    t.string    "name"
  ...
  create_table "entry_instruments", :primary_key => "entry_instrument_id", :force => true do |t|
  ...
  create_table "entry_items", :primary_key => "entry_item_id", :force => true do |t|
  ...
  create_table "entry_questions", :primary_key => "entry_question_id", :force => true do |t|
  ...
  create_table "source_content", :primary_key => "SOURCECONTENTID", :force => true do |t|
    t.integer "col_num"
    t.text    "name"
    t.integer "row_num"
    t.integer "instrument_version_id", :limit => 20
