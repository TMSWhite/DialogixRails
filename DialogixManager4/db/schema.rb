...
ActiveRecord::Schema.define(:version => 0) do
  ...
  create_table "action_types", :primary_key => "id", :force => true do |t|
    t.string "name", :default => "", :null => false
  end

  create_table "answer_list_contents", :primary_key => "id", :force => true do |t|
  ...
  create_table "answer_list_denormalizeds", :primary_key => "id", :force => true do |t|
  ...
  create_table "answer_lists", :primary_key => "id", :force => true do |t|
  end

  create_table "answer_localizeds", :primary_key => "id", :force => true do |t|
    t.text    "name"
  ...
  create_table "answers", :primary_key => "id", :force => true do |t|
    t.boolean "has_la_code", :default => false
    t.string  "la_code"
  end

  create_table "code_systems", :primary_key => "id", :force => true do |t|
    t.string "name"
    t.string "code_system_oid"
  end

  create_table "data_elements", :primary_key => "id", :force => true do |t|
    t.text     "comments"
  ...
  create_table "data_types", :primary_key => "id", :force => true do |t|
    t.string "name", :default => "", :null => false
  end

  create_table "dialogix_users", :primary_key => "id", :force => true do |t|
  ...
  create_table "display_types", :primary_key => "id", :force => true do |t|
  ...
  create_table "entry_answers", :primary_key => "id", :force => true do |t|
    t.string    "name"
    t.string    "answer_code", :limit => 10
    t.integer   "position"
    t.timestamp "created_on",                :null => false
    t.timestamp "updated_on",                :null => false
  end

  create_table "entry_answers_entry_items", :id => false, :force => true do |t|
    t.integer "entry_answer_id", :limit => 20, :null => false
    t.integer "entry_item_id",   :limit => 20, :null => false
  end

  create_table "entry_instruments", :primary_key => "id", :force => true do |t|
  ...
  create_table "entry_items", :primary_key => "id", :force => true do |t|
    t.integer   "entry_instrument_id", :limit => 20, :null => false
  ...
  create_table "entry_questions", :primary_key => "id", :force => true do |t|
    t.integer   "entry_item_id", :limit => 20
    t.string    "name"
    t.timestamp "created_on",                  :null => false
    t.timestamp "updated_on",                  :null => false
  end

  create_table "function_names", :primary_key => "id", :force => true do |t|
  ...
  create_table "help_localizeds", :primary_key => "id", :force => true do |t|
    t.string  "language_code", :limit => 2,  :default => "", :null => false
    t.text    "name"
  ...
  create_table "helps", :primary_key => "id", :force => true do |t|
  end

  create_table "instrument_contents", :primary_key => "id", :force => true do |t|
  ...
  create_table "instrument_hashes", :primary_key => "id", :force => true do |t|
  ...
  create_table "instrument_headers", :primary_key => "id", :force => true do |t|
    t.text    "name",                                :default => "", :null => false
    t.integer "instrument_version_id", :limit => 20
  ...
  create_table "instrument_load_errors", :primary_key => "id", :force => true do |t|
  ...
  create_table "instrument_sessions", :primary_key => "id", :force => true do |t|
    t.integer  "finished"
    t.integer  "num_vars"
  ...
  create_table "instrument_versions", :primary_key => "id", :force => true do |t|
  ...
  create_table "instruments", :primary_key => "id", :force => true do |t|
    t.text   "instrument_description"
    t.string "name",                   :default => "", :null => false
  end

  create_table "item_usages", :primary_key => "id", :force => true do |t|
    t.integer  "null_flavor_id",                      :null => false
    t.text     "comments"
  ...
  create_table "items", :primary_key => "id", :force => true do |t|
  ...
  create_table "language_lists", :primary_key => "id", :force => true do |t|
    t.text "name", :default => "", :null => false
  end

  create_table "loinc_instrument_requests", :primary_key => "id", :force => true do |t|
  ...
  create_table "loinc_item_requests", :primary_key => "id", :force => true do |t|
    t.string  "loinc_system"
    t.string  "loinc_scale"
    t.string  "loinc_property"
    t.string  "loinc_method"
  ...
  create_table "null_flavors", :primary_key => "id", :force => true do |t|
    t.string "name",         :default => "", :null => false
    t.string "display_name", :default => "", :null => false
    t.text   "description"
  end

  create_table "page_usage_events", :primary_key => "id", :force => true do |t|
    t.datetime "time_stamp"
  ...
  create_table "page_usages", :primary_key => "id", :force => true do |t|
  ...
  create_table "question_localizeds", :primary_key => "id", :force => true do |t|
    t.string  "language_code",   :limit => 2,  :default => "", :null => false
    t.text    "name"
  ...
  create_table "readback_localizeds", :primary_key => "id", :force => true do |t|
    t.string  "language_code", :limit => 2,  :default => "", :null => false
    t.text    "name"
    t.integer "readback_id",   :limit => 20
  end
  ...
  create_table "readbacks", :primary_key => "id", :force => true do |t|
  end

  create_table "reserved_words", :primary_key => "id", :force => true do |t|
    t.string "name",    :default => "", :null => false
    t.string "meaning"
  end

  create_table "semantic_mapping_as", :primary_key => "id", :force => true do |t|
  ...
  create_table "semantic_mapping_i_q_as", :primary_key => "id", :force => true do |t|
    t.text    "code"
    t.text    "code_display_name"
    t.integer "instrument_version_id", :limit => 20
    t.integer "answer_id",             :limit => 20
  ...
  create_table "semantic_mapping_q_as", :primary_key => "id", :force => true do |t|
    t.text    "code_display_name"
    t.text    "code"
    t.integer "code_system_id"
    t.integer "answer_id",         :limit => 20
  ...
  create_table "semantic_mapping_qs", :primary_key => "id", :force => true do |t|
    t.text    "code_display_name"
    t.text    "code"
    t.integer "code_system_id"
    t.integer "question_id",       :limit => 20
  ...
  create_table "sequence", :primary_key => "id", :force => true do |t|
    t.integer "seq_count", :limit => 38, :precision => 38, :scale => 0
  end

  create_table "source_content", :primary_key => "id", :force => true do |t|
    t.integer "col_num"
    t.text    "name"
    t.integer "row_num"
    t.integer "instrument_version_id", :limit => 20
  ...
  add_index "source_content", ["instrument_version_id"], :name => "FK_source_content_instrument_version_id"

  create_table "v1_data_elements", :primary_key => "id", :force => true do |t|
    t.integer "group_num"
    t.integer "item_visits"
    t.integer "data_element_sequence",                                   :null => false
  ...
  create_table "v1_instrument_sessions", :primary_key => "id", :force => true do |t|
    t.integer  "max_group"
    t.integer  "max_var_num"
  ...
  create_table "v1_item_usages", :primary_key => "id", :force => true do |t|
    t.text     "answer_code0"
  ...
  create_table "v1_page_usages", :primary_key => "id", :force => true do |t|
  ...
  create_table "validations", :primary_key => "id", :force => true do |t|
    t.string  "other_vals"
    t.string  "input_mask"
    t.string  "max_val"
    t.string  "min_val"
  ...
  create_table "var_names", :primary_key => "id", :force => true do |t|
    t.string "name", :default => "", :null => false
  end
